  ...
  return (
    <div className="flex flex-row justify-center my-6">
        <div className="flex flex-row w-3/4 items-center justify center space-x-4">
            ...
            />
            <UilSearchAlt size={25} className="text-white cursor-pointer transtion ease-out hover:scale-125" />
            <UilMapPinAlt size={25} className="text-white cursor-pointer transtion ease-out hover:scale-125" />
        </div>
